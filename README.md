# BCSIT Proposal Report Templates
This branch contains the LaTeX templates required for drafting your proposal report, along with an `assets/` directory for project assets and a `references.bib` file for your references.
